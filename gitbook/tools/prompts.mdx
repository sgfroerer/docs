...
<AccordionGroup>
  <Accordion title="Refined.geojson" defaultOpen={false}>
    ...
    3. Convert CSV file to geoJSON via [csvjson](https://csvjson.com/csv2json)
...
<AccordionGroup>
  <Accordion title="New Accordion" defaultOpen="false">
    ...
    Now this is from an example titled [Santa’s Workshop Dashboard](https://community.getgrist.com/t/tutorial-building-santas-workshop-dashboard-with-custom-widget-builder-a-step-by-step-guide-to-advanced-visualization-in-grist/7478)
    ...
    <!-- Line 2: Reference + Type + Status -->
      ...
      <div class="mt-2 pt-2 border-t border-blue-300">
        <div class="grid grid-cols-3 gap-4 mb-3">
          <div>
            <span class="text-yellow-200">🏭 Workshop</span>
            <div id="workshop" class="font-medium"></div>
          </div>
          <div>
            <span class="text-yellow-200">🌍 Delivery Zone</span>
            <div id="delivery_zone" class="font-medium"></div>
          </div>
          <div class="text-right">
            <span class="text-yellow-200">📅 Deadline</span>
        ...
        <div class="space-y-3">
          ...
          <div class="mt-6">
            <a id="file_link" href="#" target="_blank" 
              ...
              🎄 <span class="underline">View Complete File</span>
            </a>
          </div>
        </div>
      </div>
    ...
    function getStateColor(state) {
      ...
      return stateColors[state] || 'bg-[#90CDF4]';
    }
    ...
    function getTypeColor(type) {
      ...
      return typeColors[type] || 'bg-[#90CDF4]';
    }
    ...
    grist.onRecord(function(record) {
      ...
      if (reindeerValue === 'Yes') {
        reindeerElement.textContent = '✅ Assigned';
        reindeerElement.className = 'font-medium text-green-600';
      } else {
        reindeerElement.textContent = '❌ Not Assigned';
    ...
    Can you please use this template but make it applicable for my Grist use case, to show information for the property owner that I have selected, and the properties they own.
    ````
