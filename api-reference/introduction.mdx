...
```http
Authorization: Bearer 1ad7e6e5369fbff5d6addbe79a19d3b65455a96e
```
...
<AccordionGroup>
  <Accordion title="API Console" defaultOpen={false}>
    ...
    * **Curl**
    ...
    ```bash
    curl -X 'GET' \
      'https://docs.getgrist.com/api/docs/jP8mRM7xD8XCMYpHJH6oYC' \
  ...
  <Accordion title="Fetch records from a table" defaultOpen={false}>
    **GET** `/docs/{docId}/tables/{tableId}/records`
    ...
    ```
    curl -X 'GET' \
      'https://docs.getgrist.com/api/docs/jP8mRM7xD8XCMYpHJH6oYC/tables/Properties_/records' \
      -H 'accept: application/json' \
      -H 'Authorization: Bearer XXXXXXXXXXX'
    ```
  ...
  <Accordion title="List columns in a table" defaultOpen={false}>
    **GET**  `/docs/{docId}/tables/{tableId}/columns`
    ...
    ```
    curl -X 'GET' \
      'https://docs.getgrist.com/api/docs/jP8mRM7xD8XCMYpHJH6oYC/tables/Properties_/columns' \
      -H 'accept: application/json' \
      -H 'Authorization: Bearer XXXXXXXXXXX'
    ```
...
<Tabs>
  <Tab title="Document/Tables">
    ...
    | GET     | /docs/\{docId}/download/xlsx         | Content of document, as an Excel file  |
